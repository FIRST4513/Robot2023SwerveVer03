...
public class TalonSRXSetup {
     ...
     */
    public static void defaultSetup(TalonSRX motor, boolean isInverted, double currentLimit) {
    ...
    /**
     * Sets up the TalonSRX to use the the config and status frames
     *
     * @param motor TalonSRX to set up
     * @param config TalonSRXConfiguration to use
     */
    public static void configAllSetup(TalonSRX motor, TalonSRXConfiguration config) {
        motor.configFactoryDefault();
     ...
     */
    public static void configFollowerSetup(TalonSRX motor, TalonSRXConfiguration config) {
        motor.configFactoryDefault();
        motor.configAllSettings(config);
        defaultStatusFrames(motor);
    }
     ...
     */
    public static void simpleCurrentLimit(TalonSRX motor, double limit) {
     ...
     * @param motor the motor controller to set up
     */
    public static void defaultStatusFrames(TalonSRX motor) {
     ...
     * @param motor the motor controller to set up
     */
    public static void pidStatusFrames(TalonSRX motor) {
