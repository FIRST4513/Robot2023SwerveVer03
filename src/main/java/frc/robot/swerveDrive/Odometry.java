...
public class Odometry {
    ...
    public void update() {
        swerveOdometry.update(swerve.gyro.getHeading(), swerve.getPositions());
    }

    public void resetOdometry(Pose2d pose) {
        swerveOdometry.resetPosition(swerve.gyro.getHeading(), swerve.getPositions(), pose);
    }
