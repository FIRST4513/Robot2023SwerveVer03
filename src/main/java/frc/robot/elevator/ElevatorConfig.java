...
public class ElevatorConfig {
    ...
    public final double lowerMaxSpeed       = -0.15;
    ...
    public final double KLowerSlowSpeed     = -0.05;
    public final double KLowerSpeedDefault  = -0.15;
    ...
    public final double KElevMaxTopHt       = 31.0;             // This is the top GO NO FURTHER!
    public final double KLimitElevTopSlowHt = 28.0;		        // Start slowing the raise at this position   
    public final double KLimitElevBottomSlowHt = 3.0;           // Start slowing the lower at this position
