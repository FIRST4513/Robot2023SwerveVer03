...
public class ArmSRXMotorConfig {
    ...
    public static final int         armForwardSoftLimitThreshold       = +80000;   // TEST !!! 
     ...
     */
    public final double motionCruiseVelocity        = 2711; // 15 degrres per second
    public final double motionAcceleration          = 2711; // 1 second to get up to cruise velocity
