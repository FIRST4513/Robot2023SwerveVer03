...
public final class SwerveConfig {
    ...
    public static final double angleKP = 0.2;                   // 0.2 prev. Spectrum = 0.6
    ...
    public static final double driveKV =  (3.0 / 12.0) ;        // ( 5.0   / 12.0 );      // Spectrum = (1.72 / 12) = 0.14333
    public static final double driveKA =  (0.25 / 12.0);      // Spectrum = (0.193 / 12) = 0.0160833
